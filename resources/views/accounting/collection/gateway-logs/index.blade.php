...
<div class="container-fluid p-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex align-items-center gap-2">
      <x-integration-badge 
          type="external" 
          :systems="['GCash Webhook', 'Maya API', 'Card POS']" 
          :internalModules="['Cashier Desk', 'General Ledger']"
          :tables="['payment_gateway_logs', 'payments', 'journal_entries']"
          glImpact="DR 1030 (Digital Clearing) / CR 1110/1120 (AR Copay)" 
          description="Real-time digital settlement ingestion stream." 
      />
