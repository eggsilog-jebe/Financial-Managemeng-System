...
<div class="container-fluid p-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex align-items-center gap-2">
      <x-integration-badge 
          type="internal" 
          :internalModules="['Deposit Slips / Shifts', 'Bank Accounts', 'General Ledger']" 
          :tables="['bank_deposits', 'cashier_shifts', 'bank_accounts', 'journal_entries']"
          glImpact="DR 1020 Cash in Bank / CR 1011 Undeposited Collections"
          description="Transfers cashier collections into validated bank accounts upon teller reference entry." 
      />
