...
<div class="container-fluid p-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex align-items-center gap-2">
      <x-integration-badge 
          type="internal" 
          :internalModules="['Cashier Desk', 'General Ledger (Journal Entries)']" 
          :tables="['payments', 'journal_entries']"
          description="Audits issued receipts and validates linked double-entry General Ledger postings." 
      />
